...
class _Group3ContentState extends State<Group3Content> {
  ...
  void loadTabs() async {
    try {
      ...
      final documentSnapshot = await firestore
          .doc('/users/$uid/CPE1202L/CPE1202L/Group 3/data/')
          .get();
  ...
  void deleteTab(String tabName) async {
    try {
      ...
      final FirebaseFirestore firestore = FirebaseFirestore.instance;
      final documentRef =
          firestore.doc('/users/$uid/CPE1202L/CPE1202L/Group 3/data');
      ...
      final collectionRef =
          firestore.collection('/courses/cpe1202L/groups/3/$tabName');
  ...
  void openAttendance(BuildContext context) async {
    try {
      ...
      final newCollectionRef =
          firestore.collection('/courses/cpe1202L/groups/3/$collectionName');
    ...
    return Scaffold(
      ...
      body: StreamBuilder<DocumentSnapshot<Map<String, dynamic>>>(
        stream: FirebaseFirestore.instance
            .doc('/courses/cpe1202L/groups/3/$tabName/data')
            .snapshots(),
