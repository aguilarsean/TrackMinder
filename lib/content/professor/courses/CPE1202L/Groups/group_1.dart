...
class _Group1ContentState extends State<Group1Content> {
  ...
  void loadTabs() async {
    try {
      ...
      final documentSnapshot = await firestore
          .doc('/users/$uid/CPE1202L/CPE1202L/Group 1/data/')
          .get();
  ...
  void deleteTab(String tabName) async {
    try {
      ...
      final FirebaseFirestore firestore = FirebaseFirestore.instance;
      final documentRef =
          firestore.doc('/users/$uid/CPE1202L/CPE1202L/Group 1/data');
      ...
      final collectionRef =
          firestore.collection('/courses/cpe1202L/groups/1/$tabName');
    ...
    return Scaffold(
      ...
      body: StreamBuilder<DocumentSnapshot<Map<String, dynamic>>>(
        stream: FirebaseFirestore.instance
            .doc('/courses/cpe1202L/groups/1/$tabName/data')
            .snapshots(),
