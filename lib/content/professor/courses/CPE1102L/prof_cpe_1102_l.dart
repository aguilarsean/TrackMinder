...
class ProfCPE1102Lcontent extends StatefulWidget {
  @override
  _ProfCPE1102LcontentState createState() => _ProfCPE1102LcontentState();
}

class _ProfCPE1102LcontentState extends State<ProfCPE1102Lcontent> {
            ...
            TextButton(
              onPressed: () async {
                ...
                final courseCollection =
                    userDoc.collection('CPE1102L').doc('CPE1102L');
  ...
  void navigateToCourseContent(String groupNumber) async {
    try {
      final userDoc = userCollection!.doc(currentUserId);
      final courseCollection = userDoc.collection('CPE1102L').doc('CPE1102L');
